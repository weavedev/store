import { applyMiddleware, compose as defaultCompose, createStore, ReducersMapObject, StateFromReducersMapObject, Store } from 'redux';
...
// Prepare store
export const store: Store<StoreState, StoreActions> = ((): Store<StoreState, StoreActions> => { // tslint:disable-line:max-func-body-length
